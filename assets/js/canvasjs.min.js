...
for(0>v&&(v+=q);v<q;v++)if(v in this&&this[v]===m)return v;return-1}function y(m){return null===m||"undefined"===typeof m}function Ca(m){m.indexOf||(m.indexOf=ab);return m}function bb(m){if(W.fSDec)m[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){W._fTWm&&W._fTWm(m)})}function Ua(m,s,q){q=q||"normal";var v=m+"_"+s+"_"+q,y=Va[v];if(isNaN(y)){try{m="position:absolute; left:2px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+m+"; font-size:"+
